    ...
    <div class="content-wrapper">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a
                                    href="{{route('sales_invoice')}}">{{__('admin.sales_invoice')}}</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-md-12">
            <div class="card" id="app">
                <form class="form" action="{{route('sales_invoice.update',['id'=>$sales_invoice->id])}}" method="POST"
                      id="my_form_id"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-body">
                                                        <h4 class="form-section"><i
                                                                class='bx bxs-notebook'></i> {{__('admin.create')}} {{__('admin.sales_invoice')}}
                                                        </h4>
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group row">
                                                                    <label class="col-md-3 label-control"
                                                                           for="sale_representative_id">{{__('admin.sale_representatives')}}
                                                                        <span
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            id="sale_representative_id"
                                                                            name="sale_representative_id">
                                                                            <option
                                                                                value="">{{__('admin.select_option')}}</option>
                                                                            @foreach($sale_representative as $sale_representatives)
                                                                                <option
                                                                                    value="{{$sale_representatives->id}}" {{ $sales_invoice->sale_representative_id == $sale_representatives->id ? 'selected' : '' }}>{{$sale_representatives->name}}</option>
                                                                            @endforeach
                                                        ...
                                                        <strong></strong>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group row">
                                                                    <label class="col-md-3 label-control"
                                                                           for="customer_id">{{__('admin.customer')}}
                                                                        <span
                                                                            class="danger">*</span></label>
                                                                    <div
                                                                        class="col-md-9 mx-auto position-relative has-icon-left">
                                                                        <select
                                                                            ...
                                                                            @foreach($customer as $customers)
                                                                                <option
                                                                                    value="{{$customers->id}}" {{ $sales_invoice->customer_id == $customers->id ? 'selected' : '' }}>{{$customers->name}}</option>
                                                                            @endforeach
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <textarea required class="form-control border-primary"
                                                                                  type="text"
                                                                                  id="note"
                                                                                  name="note">{{$sales_invoice->note}}</textarea>
                                                                        <div class="form-control-position">
                                                                            <i class="icon-note"
                                                                               style="color: #b92c81"></i>
                                                                        </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="date" id="date"
                                                                               value="{{ \Carbon\Carbon::parse($sales_invoice->date)->format('Y-m-d') }}"
...
{{--                                            </td>--}}
                                                ...
                                                <div class="form-group ">
                                                    <div class="input-group">
                                                        ...
                                                        <input disabled type="text" id="user_id"
                                                               class="form-control"
                                                               value="{{$sales_invoice->user->full_name ?? ''}}"
                                                ...
                                                <div class="form-group ">
                                                    <div class="input-group">
                                                        ...
                                                        <input disabled type="text" id="created_at"
                                                               ...
                                                               value="{{ $sales_invoice->created_at}}"
                                                               style="border: none;background-color: #ffffff; border-bottom: 1px solid #b92c81; border-radius: 0; outline: none;"
                                                              >
                                                    </div>
                                                ...
                                                <div class="form-group ">
                                                    <div class="input-group">
                                                        ...
                                                        <input disabled type="text" id="updated_at"
                                                               class="form-control"
                                                               value="{{ $sales_invoice->updated_at }}"
                                ...
                                <div>
                                    ...
                                    <a href="{{ url('/sales/sales_invoice')}}"
...
@section('script')
    ...
    <script>
        window.editItems = @json($sales_invoice_details);
        window.editBillTypeId = {{ $sales_invoice->bill_type_id }};
        const app = Vue.createApp({
            ...
            methods: {
                ...
                async fetchCurrVal(item) {
                    ...
                    const res = await fetch(`/sales/sales_invoice/falter_curr_val/${item.currency_id}`);
                ...
                async removeRow(index) {
                    ...
                    if (item.id) {
                        try {
                            ...
                            await fetch(`/sales/sales_invoice/details/delete/${item.id}`, {
                                method: 'DELETE',
                                headers: {
