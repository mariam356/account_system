    ...
    <div class="content-wrapper">
        ...
        <div class="col-md-12">
            <div class="card" id="app">
                <form class="form" action="{{route('sales_invoice.store')}}" method="POST" id="my_form_id"
                                                    ...
                                                    <div class="form-body">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            @foreach($sale_representative as $sale_representatives)
                                                                                <option
                                                                                    value="{{$sale_representatives->id}}">{{$sale_representatives->name}}</option>
                                                                            @endforeach
                                                        ...
                                                        <strong></strong>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group row">
                                                                    <label class="col-md-3 label-control"
                                                                           for="customer_id">{{__('admin.customers')}}
                                                                        <span
                                                                            class="danger">*</span></label>
                                                                    <div
                                                                        class="col-md-9 mx-auto position-relative has-icon-left">
    ...
    <script>
        ...
        createApp({
            ...
            setup() {
                ...
                const baseUrl = "/sales/sales_invoice/falter_curr_val";
