@php($page_title = __('admin.sale_representatives'))
        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin.sale_representatives')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin.sale_representatives')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="media width-250 float-right">
                        ...
                        <div class="media-body media-right text-right">
                            <h3 class="m-0">@{{ currentCount }}</h3><span class="text-muted">{{__('admin.sale_representatives')}}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="content-body"  id="app">
                ...
                @canany(['update sale_representative', 'create sale_representative'])

                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                {{--                                <h4 class="card-title" id="horz-layout-colored-controls">{{__('admin.sale_representatives')}}</h4>--}}
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form id="form" @submit.prevent="saveSaleRepresentative" enctype="multipart/form-data" >
                                        @csrf
                                        <div class="form-body">
                                            <h4 class="form-section"><i class='bx bxs-truck bx-tada' ></i> {{__('admin.sale_representatives')}} </h4>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto position-relative has-icon-left">
                                                            <input type="email" id="email"
                                                                   ...
                                                                   name="email">
                                                            <div class="form-control-position">
                                                                <i class="bx bx-envelope" style="color: #b92c81"></i>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control"
                                                               for="commission">{{__('admin.commission')}}
                                                            <span
                                                                class="danger">*</span></label>
                                                        <div class="col-md-9 mx-auto position-relative has-icon-left">
                                                            ...
                                                            <span class="text-danger" v-if="errors.commission">@{{ errors.commission }}</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-9 mx-auto position-relative has-icon-left">
                                                        <input type="text"  id="search"
                                                               v-model="searchQuery"
                                                               @keyup="searchSaleRepresentative"
                                ...
                                <table id="table" class="table table-hover mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{__('admin.image')}}</th>
                                                                                    ...
                                                                                    @canany(['update sale_representative', 'delete sale_representative'])
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="(row, index) in rows" :key="row.id"  :class="{ 'tr-color-active': row.isActive }" >
                                            ...
                                            <td>
                                                <a @click.prevent="editSaleRepresentative(row.id, index)"><i class="la la-pencil-square success"></i></a>
                                                <a @click.prevent="deleteSaleRepresentative(row.id, index)" class="delete">
                        ...
                        <nav v-if="lastPage > 1">
                            <ul class="pagination justify-content-end">
                                <li class="page-item" :class="{ disabled: currentPage === 1 }">
                                    <a class="page-link" href="#" @click.prevent="loadSaleRepresentative(currentPage - 1)">{{__('admin.Previous')}}</a>
                                </li>

                                <li class="page-item" v-for="page in lastPage" :key="page" :class="{ active: currentPage === page }">
                                    <a class="page-link" href="#" @click.prevent="loadSaleRepresentative(page)">@{{ page }}</a>
                                </li>

                                <li class="page-item" :class="{ disabled: currentPage === lastPage }">
                                    <a class="page-link" href="#" @click.prevent="loadSaleRepresentative(currentPage + 1)">{{__('admin.Next')}}</a>
                                </li>
                            </ul>
                        </nav>
...
@section('script')
    ...
    @include('managements.sales.sale_representative.js')
