        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin.trial_balance')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin.trial_balance')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                {{--                                <h4 class="card-title" id="horz-layout-colored-controls">{{__('admin.trial_balance')}}</h4>--}}
                                    ...
                                    <form id="form" @submit.prevent="search" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            <h4 class="form-section"><i
                                                    class='la la-balance-scale'></i> {{__('admin.trial_balance')}} </h4>
                                            <div class="row">
                                                <div class="col-md-3">
                                ...
                                <div class="table-responsive">
                                    <table id="table" class="table table-hover mb-0">
                                        ...
                                        <tr v-for="(row, index) in rows"
                                            ...
                                            <td>
                                             <span v-if="balanceAfterCurrency(row) >= 0">
                                             @{{ balanceAfterCurrency(row).toFixed(2) }}
                                              </span>
                                                <span v-else> 0 </span>
                                            </td>
                                            <td>
                                                 <span v-if="balanceAfterCurrency(row) < 0">
                                               @{{ Math.abs(balanceAfterCurrency(row)).toFixed(2) }}
                                                 </span>
                                                <span v-else> 0 </span>
                                            </td>
...
@section('script')
    ...
    @include('managements.accounts.trial_balance.js')
