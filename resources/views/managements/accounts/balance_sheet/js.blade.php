    ...
    createApp({
        ...
        methods: {
            openReport() {
                ...
                if (currentIds) {
                    const url = `/accounts/balance_sheet/report_export?ids=${currentIds}`;
                    ...
                    window.open(`/accounts/balance_sheet/report_export?ids=${ids}`, '_blank');
                }
            },
            async search(page = 1) {
                this.loading = true;
                ...
                try {
                    const res = await axios.get('/accounts/balance_sheet/search', {
                        params: {
                            ...this.form,
                            page: page,
