    ...
    <div class="content-wrapper">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a
                                    href="{{route('exchange_bond')}}">{{__('admin.exchange_bond')}}</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-md-12">
            <div class="card" id="app">
                <form class="form" action="{{route('exchange_bond.update',['id'=>$exchange_bond->id])}}" method="POST"
                      id="my_form_id"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-body">
                                                        <h4 class="form-section"><i
                                                                class='bx bxs-notebook'></i> {{__('admin.create')}} {{__('admin.exchange_bond')}}
                                                        </h4>
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group row">
                                                                    <label class="col-md-3 label-control"
                                                                           for="check_no">{{__('admin.number')}} {{__('admin.exchange_bond')}} <span
                                                                            class="danger">*</span></label>
                                                                    <div
                                                                        class="col-md-9 mx-auto position-relative has-icon-left">
                                                                        <input readonly type="number" id="check_no"
                                                                               value="{{$exchange_bond->check_no}}"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="date" id="date"
                                                                               value="{{ \Carbon\Carbon::parse($exchange_bond->date)->format('Y-m-d') }}"
                                                                               class="form-control border-primary"
                                                                               required
                                                                               name="date">
            ...
            <strong></strong>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <textarea required class="form-control border-primary"
                                                                                  type="text"
                                                                                  id="note"
                                                                                  name="note">{{$exchange_bond->note}}</textarea>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <select  v-model="fund_id"
                                                                            ...
                                                                            @foreach($fund as $funds)
                                                                                <option
                                                                                    value="{{$funds->id}}" {{ $exchange_bond->fund_id == $funds->id ? 'selected' : '' }}>{{$funds->name}}</option>
                                                                            @endforeach
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <select  v-model="bank_id"
                                                                            ...
                                                                            @foreach($bank as $banks)
                                                                                <option
                                                                                    value="{{$banks->id}}" {{ $exchange_bond->bank_id == $banks->id ? 'selected' : '' }}>{{$banks->name}}</option>
                                                                            @endforeach
                                                ...
                                                <div class="form-group ">
                                                    <div class="input-group">
                                                        ...
                                                        <input disabled type="text" id="user_id"
                                                               class="form-control"
                                                               value="{{$exchange_bond->user->full_name ?? ''}}"
                                                ...
                                                <div class="form-group ">
                                                    <div class="input-group">
                                                        ...
                                                        <input disabled type="text" id="created_at"
                                                               ...
                                                               value="{{ $exchange_bond->created_at}}"
                                                               style="border: none;background-color: #ffffff; border-bottom: 1px solid #b92c81; border-radius: 0; outline: none;"
                                                              >
                                                    </div>
                                                ...
                                                <div class="form-group ">
                                                    <div class="input-group">
                                                        ...
                                                        <input disabled type="text" id="updated_at"
                                                               class="form-control"
                                                               value="{{ $exchange_bond->updated_at }}"
                                ...
                                <div>
                                    ...
                                    <a href="{{ url('/accounts/exchange_bond')}}"
...
@section('script')
    ...
    <script>
        window.editItems = @json($exchange_bond_details);

        const app = Vue.createApp({
            data() {
                return {
                    fund_id: '{{ $exchange_bond->fund_id ?? '' }}',
                    bank_id: '{{ $exchange_bond->bank_id ?? '' }}',
            ...
            methods: {
                async fetchCurrVal(item) {
                    ...
                    const res = await fetch(`/accounts/exchange_bond/falter_curr_val/${item.currency_id}`);
                ...
                async removeRow(index) {
                    ...
                    if (item.id) {
                        try {
                            ...
                            await fetch(`/accounts/exchange_bond/details/delete/${item.id}`, {
                                method: 'DELETE',
                                headers: {
