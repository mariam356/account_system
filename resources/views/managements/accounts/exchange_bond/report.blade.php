                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('exchange_bond')}}">{{__('admin.exchange_bond')}}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        createApp({
            ...
            methods: {
                openReport() {
                    ...
                    if (currentIds) {
                        const url = `/accounts/exchange_bond/report_export?ids=${currentIds}`;
                    ...
                    // 3. إذا لم يوجد (مثلاً صفحة عامة)، نستخدم IDs الجدول كما كنت تفعل سابقاً
                        ...
                        window.open(`/accounts/exchange_bond/report_export?ids=${ids}`, '_blank');
                    }
                },
                async loadAccount() {
                    try {
                        ...
                        let response = await axios.get(`/accounts/exchange_bond/show`, {
                            params: { ids: ids }
                        });
