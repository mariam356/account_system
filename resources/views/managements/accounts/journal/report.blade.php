                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('journal')}}">{{__('admin.journal')}}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        createApp({
            ...
            methods: {
                openReport() {
                    ...
                    if (currentIds) {
                        const url = `/accounts/journal/report_export?ids=${currentIds}`;
                    ...
                    // 3. إذا لم يوجد (مثلاً صفحة عامة)، نستخدم IDs الجدول كما كنت تفعل سابقاً
                        ...
                        window.open(`/accounts/journal/report_export?ids=${ids}`, '_blank');
                    }
                },
                async loadAccount() {
                    try {
                        ...
                        let response = await axios.get(`/accounts/journal/show`, {
                            params: { ids: ids }
                        });
