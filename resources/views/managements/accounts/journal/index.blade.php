                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{__('admin.journal')}}
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="media width-250 float-right">
                    ...
                    <div class="mb-2">
                        <button @click="printSelectedReports"
                            ...
                            <span style="font-weight: 600;"> {{ __('admin.report') }} {{__('admin.journal')}} </span>
                        ...
                        <table width="200" id="table" class="table zero-configuration">
                            ...
                            <tr>
                                ...
                                <th>{{__('admin.balance')}}</th>
                                                                                                                        ...
                                                                                                                        @canany(['update journal', 'delete journal'])
                            ...
                            <tr v-for="(row, index) in rows" :key="row.id || index">
                                ...
                                <td>
                                    <a :href="'/accounts/journal/edit/' + row.id"><i
                                            class="la la-pencil-square success"></i></a>
                                    <a class="delete" :id="row.id" @click.prevent="deleteJournal(row.id, index)"><i
                        ...
                        <ul class="pagination justify-content-end">
                            <li class="page-item" :class="{ disabled: currentPage === 1 }">
                                <a class="page-link" href="#"
                                   @click.prevent="loadJournal(currentPage - 1)">{{__('admin.Previous')}}</a>
                            </li>

                            <li class="page-item" v-for="page in lastPage" :key="page"
                                :class="{ active: currentPage === page }">
                                <a class="page-link" href="#" @click.prevent="loadJournal(page)">@{{ page }}</a>
                            </li>

                            <li class="page-item" :class="{ disabled: currentPage === lastPage }">
                                <a class="page-link" href="#"
                                   @click.prevent="loadJournal(currentPage + 1)">{{__('admin.Next')}}</a>
                            </li>
                        </ul>
                    </nav>
        ...
        createApp({
            ...
            methods: {
                ...
                printSelectedReports() {
                    ...
                    window.open(`/accounts/journal/report?ids=${idsParam}`, '_blank');
                },
                async loadJournal(page = 1) {
                    try {
                        const res = await axios.get(`/accounts/journal/show?page=${page}&table_length=${this.perPage}`);
                ...
                async deleteJournal(id, index) {
                    const route = `/accounts/journal/destroy/${id}`;
                ...
                async searchJournal() {
                    ...
                    this.searchTimer = setTimeout(async () => {
                        try {
                            let url = "/accounts/journal/search";
