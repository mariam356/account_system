@php($page_title = __('admin.account_statement'))
        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin.account_statement')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin.account_statement')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                {{--                                <h4 class="card-title" id="horz-layout-colored-controls">{{__('admin.account_statement')}}</h4>--}}
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form id="form" @submit.prevent="search"  enctype="multipart/form-data" >
                                        @csrf
                                        <div class="form-body">
                                            <h4 class="form-section"><i class='bx bxs-user-account bx-tada' ></i> {{__('admin.account_statement')}} </h4>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control"
                                                               for="operation_type_id">{{__('admin.operation_type')}}  <span
                                                                class="danger">*</span></label>
                                                        <div class="col-md-9 mx-auto position-relative has-icon-left">
                                                            <select class="form-control border-primary"  v-model="form.operation_type_id" id="operation_type_id" name="operation_type_id">
                                                                <option value="">{{__('admin.select_option')}}</option>
                                                                @foreach($operation_type as $operation_types)
                                                                    <option value="{{$operation_types->id}}">{{$operation_types->name}}</option>
                                                                @endforeach
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control"
                                                               for="currency_id">{{__('admin.currency')}}  <span
                                                                class="danger">*</span></label>
                                                        <div class="col-md-9 mx-auto position-relative has-icon-left">
                                                            <select  v-model="form.currency_id" class="form-control border-primary" id="currency_id" name="currency_id">
                                                                <option value="">{{__('admin.select_option')}}</option>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control"
                                                               for="curr_val">{{__('admin.curr_val')}} <span
                                                                class="danger">*</span></label>
                                                        <div class="col-md-9 mx-auto position-relative has-icon-left">
                                                            <input readonly class="form-control border-primary" type="text"
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control"
                                                               for="account_id">{{__('admin.account_number')}}  <span
                                                                class="danger">*</span></label>
                                                        <div class="col-md-9 mx-auto position-relative has-icon-left">
                                                            <select v-model="form.account_id" class="form-control border-primary" id="account_id" name="account_id">
                                                                <option value="">{{__('admin.select_option')}}</option>
                                                                @foreach($account as $accounts)
                                                                    <option
                                                                        value="{{$accounts->id}}">{{$accounts->acc_code}}
                                ...
                                <table id="table" class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="(row, index) in rows"
                                            ...
                                            <td>@{{ form.curr_val ? (row.acc_debit / form.curr_val) : row.acc_debit }}</td>
                                            <td>@{{ form.curr_val ? (row.acc_credit / form.curr_val) : row.acc_credit }}</td>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group ">
                                                <div class="input-group">
                                                    ...
                                                    <input  style="border: none;background-color: #ffffff; border-bottom: 1px solid #b92c81; border-radius: 0; outline: none;" readonly type="text" id="debit"
                                                           class="form-control"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group ">
                                                <div class="input-group">
                                                    ...
                                                    <input  style="border: none;background-color: #ffffff; border-bottom: 1px solid #b92c81; border-radius: 0; outline: none;" readonly type="text" id="credit"
                                                           class="form-control"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group ">
                                                <div class="input-group">
                                                    ...
                                                    <input  style="border: none;background-color: #ffffff; border-bottom: 1px solid #b92c81; border-radius: 0; outline: none;" readonly type="text" id="balance"
                                                           class="form-control"
...
@section('script')
    ...
    @include('managements.accounts.account_statement.js')
