        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin.profit_loss')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin.profit_loss')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                {{--                                <h4 class="card-title" id="horz-layout-colored-controls">{{__('admin.profit_loss')}}</h4>--}}
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form id="form" @submit.prevent="search" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <h4 class="form-section"><i class='bx bx-line-chart-down bx-tada' ></i> {{__('admin.profit_loss')}} </h4>
                                            <div class="row">
                                                <div class="col-md-3">
...
@section('script')
    ...
    @include('managements.accounts.profit_loss.js')
