@php($page_title = __('admin.suppliers'))
        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin.suppliers')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin.suppliers')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="media width-250 float-right">
                        ...
                        <div class="media-body media-right text-right">
                            <h3 class="m-0">@{{ currentCount }}</h3><span class="text-muted">{{__('admin.suppliers')}}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="content-body"  id="app">
                ...
                @canany(['update suppliers', 'create suppliers'])
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                {{--                                <h4 class="card-title" id="horz-layout-colored-controls">{{__('admin.suppliers')}}</h4>--}}
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form id="form" @submit.prevent="saveSuppliers" enctype="multipart/form-data" >
                                        @csrf
                                        <div class="form-body">
                                            <h4 class="form-section"><i class='bx bxs-truck bx-tada' ></i> {{__('admin.suppliers')}} </h4>
                                            <div class="row">
                                                <div class="col-md-3">
                                ...
                                <table id="table" class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="(row, index) in rows" :key="row.id"  :class="{ 'tr-color-active': row.isActive }" >
                                            ...
                                            <td>
                                                <a @click.prevent="editSuppliers(row.id, index)"><i class="la la-pencil-square success"></i></a>
                                                <a @click.prevent="deleteSuppliers(row.id, index)" class="delete">
                        ...
                        <nav v-if="lastPage > 1">
                            <ul class="pagination justify-content-end">
                                <li class="page-item" :class="{ disabled: currentPage === 1 }">
                                    <a class="page-link" href="#" @click.prevent="loadSuppliers(currentPage - 1)">{{__('admin.Previous')}}</a>
                                </li>
                                ...
                                <li class="page-item" :class="{ disabled: currentPage === lastPage }">
                                    <a class="page-link" href="#" @click.prevent="loadSuppliers(currentPage + 1)">{{__('admin.Next')}}</a>
                                </li>
                            </ul>
                        </nav>
...
@section('script')
    ...
    @include('managements.purchases.suppliers.js')
