        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin.banks')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin.bank')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="media width-250 float-right">
                        ...
                        <div class="media-body media-right text-right">
                            <h3 class="m-0">{{$data_count}}</h3><span class="text-muted">{{__('admin.banks')}}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="content-body">
                ...
                @canany(['update bank', 'create bank'])
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                {{--                                <h4 class="card-title" id="horz-layout-colored-controls">{{__('admin.banks')}}</h4>--}}
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form id="form">
                                        @csrf
                                        <div class="form-body">
                                            <h4 class="form-section"><i class='bx bxs-bank bx-tada' ></i> {{__('admin.banks')}} </h4>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control"
                                                               for="account_id">{{__('admin.account_number')}}  <span
                                                                class="danger">*</span></label>
                                                        <div class="col-md-9 mx-auto position-relative has-icon-left">
                                                            <select class="select2 form-control border-primary" id="account_id" required name="account_id">
                            ...
                            <div class="card-content collapse show">
                                ...
                                <table id="table" class="table table-hover mb-0">
                                    ...
                                    @foreach($data as $bank)
                                        <tr>
                                            <td hidden>{{$bank->updated_at}}</td>
                                            <td>{{ $bank->id }}</td>
                                            <td>{{ $bank->name }}</td>
                                            <td>{{$bank->account->acc_code ?? ""}}</td>
...
@section('script')
    ...
    @include('managements.system_setting.bank.js')
