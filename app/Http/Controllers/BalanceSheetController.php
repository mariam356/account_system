...
use App\Exports\BalanceSheetExports;
...
{
    public $view_path = 'managements.accounts.balance_sheet.';
    public function index(Request $request)
    {


        return view('managements.accounts.balance_sheet.index')
    ...
    public function getSearchQuery(Request $request)
    {
        ...
        $query = JournalDetail::whereIn('journal_id', $journalIds)
            ...
            ->whereHas('account', function ($sub) use ($request) {
                $sub->where('acc_report_type_id', 1);
            })
    ...
    public function export(Request $request)
    {
        ...
        $report = new BalanceSheetExports($data, $request);
